...
def create_dataloader(path, imgsz, batch_size, stride, names, single_cls=False, hyp=None, augment=False, cache=False, pad=0.0,
    ...
    if rect and shuffle:
        ...
        shuffle = False
    print("create_dataloader处names是：", names)
...
def flatten_recursive(path='D:/BaiduNetdiskDownload/data_obb/train'):
...
def extract_boxes(path='D:/BaiduNetdiskDownload/data_obb/train'):  # from utils.datasets import *; extract_boxes()
...
def autosplit(path='D:/BaiduNetdiskDownload/data_obb/train/images', weights=(0.9, 0.1, 0.0), annotated_only=False):
...
def verify_image_label(args):
    ...
    print("verify中的cls_name_list", cls_name_list)
...
def dataset_stats(path='E:/yolov5_obb-master/yolov5_obb-masterdata/DroneVehicle_poly.yaml', autodownload=False, verbose=False, profile=False, hub=False):
